...
app13.factory('HelloFactory', function($window) {
	var factory = {};
...
// access its method
app13.controller('mainCtrl', function(HelloService, HelloFactory,$window) {
	$window.	alert("view Degubber mode : console login");
